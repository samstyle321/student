  ...
  <body>
    ...
    <form name="myfor" action="atupdateelectronics.php" method="post" id="myfor">
      ...
      <?php 
        ...
        echo '<input type="number" name="ofct" id="oss" autocomplete="off" onkeyup="add()"/><br><br>';
         echo ' <label>WMC</label>';
        echo '<input type="number" name="wmct" id="bom" autocomplete="off" onkeyup="add()"/><br><br>';
         echo ' <label>IPLC</label>';
        echo '<input type="number" name="iplct" id="elective" autocomplete="off" onkeyup="add()"/><br><br>';
         echo ' <label>CN</label>';
        echo '<input type="number" name="cnt" id="bom" autocomplete="off" onkeyup="add()"/><br><br>';
      ...
      <?php 
        echo ' <label >OFC</label>';
        echo ' <input type="number" name="ofcp" id = "cg" autocomplete="off" onkeyup="add()"/><br><br>';
        echo ' <label>WMC</label>';
        echo '<input type="number" name="wmcp" id="oss" autocomplete="off" onkeyup="add()"/><br><br>';
        echo ' <label>IPLC</label>';
        echo '<input type="number" name="iplcp" id="elective" autocomplete="off" onkeyup="add()"/><br><br>';
