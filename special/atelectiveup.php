...
<html>
  ...
  <body>
    ...
    <form name="myfor" action="atelectiveup.php" method="post" id="myfor">
      <center>
      ...
      <?php 
        ...
        echo ' <input type="number" name="electivet" id = "electivet" autocomplete="off" onkeyup="add()"/><br><br>';
...
if(isset($_POST['update']))
{
   ...
   $query = "UPDATE `computerat` SET `electivet`='".$electivet."',`electivep`=$electivep WHERE `rollno` = $rollno";
